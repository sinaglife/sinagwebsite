...
export default (props) => (
  ...
  <svg {...props} xmlns={xmlns} viewBox="0 0 504 504">
    <polygon xmlns={xmlns} fill="#3C58BF" points="184.8,324.4 210.4,180.4 250.4,180.4 225.6,324.4 "/>
    <polygon xmlns={xmlns} fill="#293688" points="184.8,324.4 217.6,180.4 250.4,180.4 225.6,324.4 "/>
    <path
      fill="#3C58BF"
    ...
    />
    <polygon xmlns="http://www.w3.org/2000/svg" fill="#051244" points="225.6,324.4 191.2,289.2 184.8,324.4"/>
    <path 
    fill="#051244"
